        ...
        <div class="row">
            <div class="center col-md-8">
                <div class="panel panel-info" >  
                    <h1 class="my-4"><span class="title px-3">Edit Book
                        </span></h1>
                    <div class="panel-body">
                        <form class="form-horizontal needs-validation" novalidate method="POST"  action="{{ url('/viewbook/'.$books->id.'/edit/save') }}" enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" required name="title" value="{{$books->title}}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group wrap-input100 validate-input" data-validate = "Valid Year is required">
                                                    ...
                                                    <input type="number" class="form-control" value="{{$books->year}}" required name="year" max=2100 onkeydown="return ( event.ctrlKey || event.altKey 
                                            ...
                                            <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="tag" value="{{$books->tag}}">
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="form-group wrap-input100 validate-input" data-validate = "Valid author is required">
                                            <label for="">Author</label>
                                            <input type="text" class="input100 form-control" required name="author" value="{{$books->author}}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group wrap-input100 validate-input" data-validate = "Valid Publisher is required">
                                            ...
                                            <input type="text" class="input100 form-control" required name="publisher" value="{{$books->publisher}}">
                                                <div class="invalid-feedback">
